  ...
  return {
    ...
    link: function (scope, element) {
      ...
      function poll() {
        ...
        bngApi.engineLua("pcall(extensions.load, 'alpine_rt')", function () {
          bngApi.engineLua(
            "(extensions.alpine_rt and extensions.alpine_rt.getTrafficMap and extensions.alpine_rt.getTrafficMap()) "
